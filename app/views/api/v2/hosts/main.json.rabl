...
if @parameters
  node do |host|
    { :parameters => partial("api/v2/parameters/base", :object => host.lookup_values.globals.authorized) }
  end
end

if @all_parameters
  node do |host|
    { :all_parameters => partial("api/v2/parameters/base", :object => host.host_params) }
  end
end
