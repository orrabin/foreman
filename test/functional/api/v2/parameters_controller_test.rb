...
class Api::V2::ParametersControllerTest < ActionController::TestCase
  ...
  test "should create host parameter" do
    ...
    assert_difference('host.parameters.count') do
      post :create, { :host_id => host.to_param, valid_attrs }
    end
    assert_response :success
  end
  ...
  test "should create domain parameter" do
    ...
    assert_difference('domain.parameters.count') do
      post :create, { :domain_id => domain.to_param, valid_attrs }
    end
    assert_response :success
  end
  ...
  test "should create hostgroup parameter" do
    ...
    assert_difference('hostgroup.group_parameters.count') do
      post :create, { :hostgroup_id => hostgroup.to_param, valid_attrs }
    end
    assert_response :success
  end
  ...
  test "should create os parameter" do
    ...
    assert_difference('os.parameters.count') do
      post :create, { :operatingsystem_id => os.to_param, valid_attrs }
    end
    assert_response :success
  end

  test "should update nested host parameter" do
     put :update, { :host_id => hosts(:one).to_param, :id => parameters(:host).to_param, valid_attrs  }
     assert_response :success
  ...
  test "should update nested domain parameter" do
     put :update, { :domain_id => domains(:mydomain).to_param, :id => parameters(:domain).to_param, valid_attrs  }
     assert_response :success
  ...
  test "should update nested hostgroup parameter" do
     put :update, { :hostgroup_id => hostgroups(:common).to_param, :id => parameters(:group).to_param, valid_attrs  }
     assert_response :success
  ...
  test "should update nested os parameter" do
     put :update, { :operatingsystem_id => operatingsystems(:redhat).to_param, :id => parameters(:os).to_param, valid_attrs  }
     assert_response :success
